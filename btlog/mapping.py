...
df_state = pd.read_excel(r'E:\project\public\number\trunk\Z-战斗新表.xlsx', sheet_name='状态分类表') 
df_attrs = pd.read_excel(r'E:\project\public\number\trunk\Z-战斗新表.xlsx', sheet_name='属性') 
...
# 将 '唯一标识' 和 '描述' 映射为字典
state_mapping = df_state.iloc[3:,1:3].set_index('唯一标识')['描述'].to_dict()
# 将 '代码' 和 '属性变量' 映射为字典
attrs_mapping = df_attrs.iloc[3:,1:4].set_index('代码')['属性变量'].to_dict()
